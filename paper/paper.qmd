...
products <- read_parquet("~/Canadian-Bread-Pricing-Analysis/data/02-analysis_data/analysis_data.parquet")
time_data <- read_parquet("~/Canadian-Bread-Pricing-Analysis/data/02-analysis_data/nowtime_data.parquet")
```
...
The discussion section contains an in-depth look at the results and interprets them to come to conclusions about the estimand, as well as other practical conclusions that may be drawn. It also touches on the limitations of the model, what it cannot be used to tell us, and how the data and model can be refined to gain further information.
